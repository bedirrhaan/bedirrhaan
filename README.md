...
pipeline = (
    ...
    | bypass(anti_bot=True)       # Turnstile · rate-limits · fingerprints
    | extract(schema=StrictModel)
    | export(fmt=["csv", "json", "sql"])
)
```
...
<div align="center">
  <img src="https://skillicons.dev/icons?i=python,selenium,nodejs,ts,c,cpp,bash,fastapi,postgres,redis,docker,linux,git,github&perline=7" alt="skills" />
</div>
...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/bedirrhaan/bedirrhaan/output/github-contribution-grid-snake-dark.svg" />
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/bedirrhaan/bedirrhaan/output/github-contribution-grid-snake.svg" />
    <img alt="github contribution snake" src="https://raw.githubusercontent.com/bedirrhaan/bedirrhaan/output/github-contribution-grid-snake.svg" width="100%" />
  </picture>
</div>
